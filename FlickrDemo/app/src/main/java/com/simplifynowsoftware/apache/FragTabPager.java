...
public abstract class FragTabPager extends FragmentActivity {
    ...
    public static class TabsAdapter extends FragmentPagerAdapter
        ...
        public void addTab(TabHost.TabSpec tabSpec, Class<?> clss, Bundle args) {
            ...
            if(mTabHeight != DEFAULT_TAB_HEIGHT) {
                mTabHost.getTabWidget().getChildAt(mTabHost.getTabWidget().getChildCount() - 1).getLayoutParams().height = mTabHeight;
            }
        }
